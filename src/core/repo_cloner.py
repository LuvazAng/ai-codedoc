...
import git, git.exc
from config.conf import REPOS_DIR
...
class RepoCloner:
    ...
    def _identify_platform(self, hostname: str) -> str:
        """Identifies the platform based on the hostname."""
    ...
    def _build_authentication_url(
        ...
        """Builds the authenticated URL for cloning."""
        ...
        self.logger.info("Using token for authentication. Platform: %s", platform)
